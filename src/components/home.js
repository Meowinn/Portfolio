    ...
    return (
        <div id="home">
            ...
            <div className="animateBg">
                ...
                <div  id="startWrapper" data-aos="fade-right" >
                    <div className="container-fluid">
                        <div className="pt-5"><h1 className="startTitle">Hi, I'm Darwin | <span className="positionText">Self-taught </span><br/><span className="positionText">Front-end Dev</span></h1></div>
